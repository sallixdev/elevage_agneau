...
<body>
	...
	<section id="animaux">
		...
		$recupArticles = $bdd->prepare('SELECT * FROM articles WHERE id_user = ? ORDER BY date_time_publication ');
	...
	while($article = $recupArticles->fetch()){
		?>
			...
			<div class="articles" >
				<h2><?= $article['titre']; ?></h2>
				<p>Date de naissance :<?= $article['dateNaissance'];?></p>
				<p>Date de traitement :<?= $article['dateTraitement'];?></p>
